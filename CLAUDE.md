<!-- rsi-worker-metadata
  workerId=4c9decac-56ea-43a0-98cc-b69b06a45a06
  productId=99ea2264-6241-513a-9605-df93ce86112c
  scopeConfigHash=7ec90ec5aa1a50e1
  generatedAt=2026-04-28T04:53:03.622Z
-->
# Astro Static Site Starter

## Project Overview

Content-heavy static site built with Astro 6, Tailwind CSS 4, and TypeScript 5. Outputs pre-rendered HTML with zero JavaScript by default.
...
src/
  ...
  tests/
    ...
    seo.test.ts                   # Source-level logic tests for SEO component: canonical URL normalisation, OG/twitter image URL resolution, og:type mapping, og:locale, twitter:image:alt fallback (resolveImageAlt), OG and Twitter tag content values, and default prop values
...
- **Integration tests** (routes, endpoints, multi-module flows): `src/tests/`
  ...
  - `src/tests/seo.test.ts` — source-level logic tests for SEO component: canonical URL normalisation, OG/twitter image URL resolution, og:type mapping, og:locale, twitter:image:alt fallback (resolveImageAlt), OG and Twitter tag content values, and default prop values
